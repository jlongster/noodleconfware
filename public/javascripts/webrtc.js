...
// this is stripped from the webrtc.io library [1], which was/is messy and
// buggy. we can clean up and hack on it from here. see the
// initialization code at the bottom.
//
// [1] https://github.com/webRTC/webRTC.io
...
rtc.SERVER = { iceServers: [{ url:"stun:173.194.76.127:19302" }] };
rtc.peerConnections = {};
rtc.connections = [];
rtc.streams = [];
rtc.numStreams = 0;
...
console.log('dataChannelSupport', rtc.dataChannelSupport);
...
rtc.createPeerConnection = function(id) {
    ...
    config['optional'] = [{'DtlsSrtpKeyAgreement': 'true'}];
...
rtc.sendOffer = function(socketId) {
    ...
    }, null, { 'mandatory': { 'MozDontOfferDataChannel':true }});
};
...
rtc.connect('ws:' + window.location.href.substring(window.location.protocol.length));
